...
import { getCompanyDisplayName, getCompanyGradient, getCompanyIcon } from "../utils/companyHelper";
  ...
  useEffect(() => {
    const fetchCompanies = async () => {
      try {
        ...
        const res = await axios.get("https://api.mymaxkapital.com/companies/list", { headers });
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50 text-gray-800 px-4">
        <div className="max-w-md w-full bg-white p-8 rounded-xl shadow-md border border-gray-200">
          ...
          <button 
            ...
            className="w-full py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors font-semibold shadow-md shadow-blue-500/10"
          >
            Try Again
          </button>
        </div>
          ...
          <div className="max-w-md mx-auto">
            <div className="relative">
              ...
              <input
                ...
                className="block w-full pl-10 pr-3 py-3 bg-white border border-gray-200 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-all rounded-lg"
              />
            </div>
          </div>
        </div>
        ...
        {filteredCompanies.length === 0 ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {filteredCompanies.map((company) => {
              const gradientClass = getCompanyGradient(company.name);
              ...
              return (
                <div
                  ...
                  className="cursor-pointer group bg-white hover:bg-gray-50 transition-all duration-300 overflow-hidden border border-gray-200/80 shadow-sm hover:shadow-md"
                >
                  <div className="p-6">
                    <div className="flex items-center mb-5">
                      <div className={`w-14 h-14 bg-gradient-to-br ${gradientClass} rounded-full flex items-center justify-center text-white shadow-lg transition-transform duration-300 group-hover:scale-110`}>
                    ...
                    <div className="flex justify-between items-center mt-6 pt-4 border-t border-gray-100">
                      ...
                      <button className="text-sm text-gray-500 hover:text-blue-600 transition-colors flex items-center font-medium">
                        View details
